...
const Shome = () => {
  ...
  return (
    ...
    <div className='content'>
        {/* <h3>Welcome</h3>  */}
        <h3>Unleash the power of teamwork as you connect, collaborate, and create. Scale your dreams into reality with our collaborative platform .<br/></h3>
      ...
      <div className='slider-images'>
        <div className='slider-img'>
          ...
          <div className='details'>
            {/* <h2></h2> */}
            <p>Need a job, this is the right place to scale your impact and teamwork.</p>
          </div>  
        </div>
        ...
        <div className='slider-img'>
          ...
          <div className='details'>
            {/* <h2></h2> */}
            <p>Scale your projects and dreams with the power of collaboration</p>
          </div> 
        </div>
        ...
        <div className='slider-img'>
          ...
          <div className='details'>
            <h2></h2>
            <p>Connect with like-minded individuals for collaborative success.</p>
          </div> 
        </div>
        <div className='slider-img'>
          <img src={bg5} alt="6"/>
